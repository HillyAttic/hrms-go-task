...
- Name: project-modal-users.test.ts >> ProjectModal - Team Members User Selector >> should handle API returning undefined-like shape gracefully
- Location: src\__tests__\e2e\project-modal-users.test.ts:96:7
